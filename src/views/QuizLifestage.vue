      ...
      <div class="section">
        <div class="container">
          <div class="md-layout">
              ...
              <div class="md-layout">
                <div class="md-layout-item md-medium-size-25 md-small-size-100">
                  <div
                    ...
                    :class="{ border: lifestage == 'Student' }"
                  >
                      ...
                      <md-ripple>
                        ...
                        <md-card-content>
                          ...
                          <p class="card-description">
                            Still in school but you want to be one step ahead of
                            your peers
                          </p>
                        </md-card-content>
                      </md-ripple>
                ...
                <div class="md-layout-item md-medium-size-25 md-small-size-100">
                  <div
                    class="lifestage"
                    @click="onClickGrad()"
                    :class="{ border: lifestage == 'Graduate' }"
                  >
                    <md-card class="md-card-plain" md-with-hover>
                      <md-ripple>
                        <md-card-media>
                ...
                <div class="md-layout-item md-medium-size-25 md-small-size-100">
                  <div
                    class="lifestage"
                    @click="onClickExp1()"
                    :class="{ border: lifestage == 'Early Professional' }"
                  >
                    <md-card class="md-card-plain" md-with-hover>
                      <md-ripple>
                        <md-card-media>
                        ...
                        <md-card-content>
                          ...
                          <p class="card-description">
                            Have some work experience but you are looking to
                            switch industries
                          </p>
                        </md-card-content>
                      </md-ripple>
                ...
                <div class="md-layout-item md-medium-size-25 md-small-size-100">
                  <div
                    class="lifestage"
                    @click="onClickExp2()"
                    :class="{ border: lifestage == 'Experienced Professional' }"
                  >
                    <md-card class="md-card-plain" md-with-hover>
                      <md-ripple>
                        <md-card-media>
                        ...
                        <md-card-content>
                          ...
                          <p class="card-description">
                            An industry veteran that is keeping abreast of the
                            latest developments
                          </p>
                        </md-card-content>
                      </md-ripple>
            ...
            <div
              class="md-layout-item md-size-66 md-xsmall-size-100 mx-auto text-right"
            >
              <md-button
